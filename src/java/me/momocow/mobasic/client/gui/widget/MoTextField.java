...
public class MoTextField extends Gui
{
   ...
   protected int textureHeight;
    ...
    public MoTextField(int componentId, FontRenderer fontrendererObj, 
    		int x, int y, 
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton)
    {
        ...
        if (this.isFocused && flag && mouseButton == 0 && this.isEnabled)
        {
